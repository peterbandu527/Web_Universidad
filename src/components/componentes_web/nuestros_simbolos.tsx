const Nuestros_simbolos = () => {
  return (
    <div className="container mt-5 mb-5"> 
      ...
      <div className="row">
        <div className="col-12 col-lg-5 col-md-5 mt-5" style={{background:'rgba(12, 127, 207, 0.09)',padding:'5%',borderRadius:'2%'}}>
        ...
        <div className="col-12 col-lg-2 col-md-2 mt-5 d-flex align-items-center" >
